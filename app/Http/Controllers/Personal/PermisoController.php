        ...
        try{
            ...
            foreach($notifica as $data){
                ...
                if($solo_anio_ini >= $año_ini_selecc){
                    ...
                    ->where('id_funcionario', $idfunc)
                    ->whereBetween('fecha_ini',[$año_ini_selecc."-01-01", $año_ini_selecc."-12-31"])
                    ->first();
                    ...
                    if(!is_null($existe)){
                        ...
                        $cant=$data->cant_hora;
                        $cant=explode(":",$cant);
                        $cant_dia_aux=$cant_dia_aux +$cant[0];
                    }
                }else{
                    if($solo_anio_fin <= $año_fin_selecc){
                        $existe=Permiso::where('estado','A')
                        ->where('id_permiso', $data->id_permiso)
                        ->where('id_funcionario', $idfunc)
                        ->whereBetween('fecha_fin',[$año_fin_selecc."-01-01", $año_fin_selecc."-12-31"])
                        ->first();
                        ...
                        if(!is_null($existe)){
                            ...
                            $date1 = new \DateTime($año_fin_selecc."-01-01");
            ...
            $notifica=['cantidadHoras'=>$cant_dia_aux];
