...
$("#form_medicina").submit(function(e){
    ...
    var url_busqueda=""
    if(bodega_selecc==6 || bodega_selecc==20){
        url_busqueda="listado-medicamentos-lote-farmacia/"+txt_item+"/"+bodega_selecc;
    }else if(bodega_selecc==7 || bodega_selecc==21){
        url_busqueda="listado-insumos-lote-farmacia/"+txt_item+"/"+bodega_selecc;
        ...
        url_busqueda="listado-lab-lote-farmacia/"+txt_item+"/"+bodega_selecc; 
    }
...
function guardarEgresoBodega(){
    ...
    var cmb_proveedor=$("#cmb_proveedor").val() 
    ...
    if(cmb_tipo=='Externo'){
        if(cmb_proveedor==""){
            alertNotificar("Seleccione la institucion","error")
            return
        }
    }
...
$("#form_egreso_bodega").submit(function(e){
    ...
    let url_form=""
    var cmb_tipo=$("#cmb_tipo").val()   
    if(cmb_tipo=="Devolucion"){
        url_form="guardar-devolucion-farma-bodega"
    }else{
        url_form="guardar-egreso-bodega-farma"
    }
