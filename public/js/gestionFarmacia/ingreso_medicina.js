...
$("#form_medicina").submit(function(e){
    ...
    if(tipo_ingreso==4){
        ...
        }else if(bodega_selecc==22 || bodega_selecc==27){
            url_busqueda="listado-lab-mat-filtra-dev/"+txt_item+"/"+bodega_selecc;
        }else if(bodega_selecc==25 || bodega_selecc==28){
            url_busqueda="listado-lab-mat-filtra-dev/"+txt_item+"/"+bodega_selecc;
        }else if(bodega_selecc==26 || bodega_selecc==29){
            url_busqueda="listado-lab-mat-filtra-dev/"+txt_item+"/"+bodega_selecc;
...
//funcion para cuando selecciona un material del combo
function agg_medicamento(id_item,nombrex, bodega){
...
function validaMedAgg(){
    ...
    if(bodega_selecc==1 || bodega_selecc==2 || bodega_selecc==8 || bodega_selecc==13 
        || bodega_selecc==20 || bodega_selecc==21 ){
...
function guardarIngresoBodega(){
    ...
    //solo cuando sea medic, ins, lab mat y lab react validamos estos campos
    if(bodega_selecc==6 || bodega_selecc==7 || bodega_selecc==20 || bodega_selecc==21 || bodega_selecc==22 || bodega_selecc==25 || bodega_selecc==27 || bodega_selecc==28){
...
$("#form_ingreso_bodega").submit(function(e){
    ...
    if(AccionForm=="R"){
        tipo="POST"
        url_form="guardar-ingreso-bodega-farmacia"
    }else{
        tipo="PUT"
