...
$("#form_medicina").submit(function(e){
    ...
    var url_busqueda=""
    if(bodega_selecc==1 || bodega_selecc==6 || bodega_selecc==17){ //medicamentos 
        url_busqueda="listado-medicamentos-lote/"+txt_item+"/"+bodega_selecc; 
    }else if(bodega_selecc==2 || bodega_selecc==7 || bodega_selecc==18 || bodega_selecc==21){ //insumos 
...
function agg_medicamento(id_item,nombrex, bodega, cantidad, precio, felab, fcad, lote, rsanitario,idbodprod, permitir){
    ...
    globalThis.IdBodegaCarrito=bodega
...
function guardarEgresoBodega(){
    ...
    if(IdBodegaCarrito != cmb_bodega){
        alertNotificar("Los items agregados no corresponde a la bodega seleccionada","error")
        return
    }
...
$("#form_pedido_bodega").submit(function(e){
    ...
    // 
        ...
        url_form="guardar-pedido-bodega-farm-insumo"
    }
