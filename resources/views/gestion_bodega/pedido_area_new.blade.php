...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Administración de Pedido a Bodega 
        </h1>
            ...
            <div class="box-body">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select data-placeholder="Seleccione Una Bodega" style="width: 100%;" class="form-control select2" name="cmb_bodega" id="cmb_bodega" onchange="bodegaSeleccionada()" >
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-center" >
                            ...
                            <button type="button" class="btn btn-success btn-sm" onclick="guardarPedidoBodega()">
                                Guardar
                            </button>
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionBodega/pedido_bodega_gral_new.js?v='.rand())}}"></script>
