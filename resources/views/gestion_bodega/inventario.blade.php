...
@section('content')
    ...
    <section class="content" id="content_form">
        ...
        <div class="box" id="listado_persona">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12" id="content_consulta">
                    <form id="frm_buscar" class="form-horizontal" action="" autocomplete="off">
                        ...
                        <div class="box-body">
                            ...
                            {{-- <div class="form-group" id="seccion_cmb_filtra" style="display: none">
                ...
                <div id="listado_individual" style="display: none" >
                    ...
                    <div class="col-md-12">
                        <center>
                            {{-- <button type="button" class="btn btn-xs btn-success" onclick="descargarPdfIndividual()">Descargar</button> --}}
                ...
                <div id="listado_global" style="display: none">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {{-- <ul class="nav nav-pills nav-stacked fecha_fil"style="margin-left:80px">
                                <li style="border-color: white"><a><i class="fa fa-calendar text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Desde</b>: <span  id="desde_seleccionada"></span></a></li>
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <ul class="nav nav-pills nav-stacked fecha_fil"style="margin-left:22px">
                                <li style="border-color: white"><a><i class="fa fa-calendar text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Hasta</b>: <span  id="hasta_seleccionada"></span></a></li>
                        ...
                        <table id="tabla_inventario_global" width="100%"class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Pre Prom</th>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div id="listado_detalle_suma" style="display: none">
                                ...
                                <div class="col-md-12" style="margin-top: 15px !important">
                                    <center>
                                        <button onclick="atras()"   type="button" class="btn btn-danger btn-xs" ><span class="fa fa-times"></span> Regresar</button>
        ...
        <div class="modal fade_ detalle_class"  id="modal_detalle_producto_suma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="row_">
                                <div class="col-md-6">
                                    ...
                                    <ul class="nav nav-pills nav-stacked"style="margin-left:10px">
                                        <li style="border-color: white"><a><i class="fa fa-sort-numeric-asc text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Suma</b>: <span  id="suma_seleccionada"></span></a></li>
                                       
                                    </ul>
                                    <ul class="nav nav-pills nav-stacked"style="margin-left:10px">
                                        <li style="border-color: white"><a><i class="fa fa-shopping-cart text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Item</b>: <span  id="item_seleccionada"></span></a></li>
                                ...
                                <div class="col-md-6">
                                    <ul class="nav nav-pills nav-stacked"style="margin-left:10px">
                                        <li style="border-color: white"><a><i class="fa fa-sort-numeric-desc text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Resta</b>: <span  id="resta_seleccionada"></span></a></li>
                                       
                                    </ul>

                                    <ul class="nav nav-pills nav-stacked" style="margin-left:10px">
                                        <li style="border-color: white"><a><i class="fa fa-sort-numeric-asc text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Total:</b> <span  id="total_seleccionado"> </span></a></li>
                            ...
                            <div class="col-md-12" style="margin-top: 15px !important">
                                <center>
                                    <button onclick="cerrarSumaResta()"  id="btn_cancelar_" type="button" class="btn btn-danger btn-xs" ><span class="fa fa-times"></span> Cerrar</button>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title">REPORTERIAS</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionBodega/inventario.js?v='.rand())}}"></script>
