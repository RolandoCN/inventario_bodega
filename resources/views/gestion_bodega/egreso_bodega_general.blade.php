...
<link rel="stylesheet" href="{{asset('bower_components/sweetalert/sweetalert.css')}}">
    <section class="content-header">
        <h1>
            Administración de Egreso a Bodega
        </h1>
            ...
            <div class="box-body">
                ...
                {{ csrf_field() }}
                    ...
                    <div id="retirado_seccion" style="display: none">
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label">Retirado Por</label>
                            <div class="col-sm-5">
                                <input type="number" onkeyup="presionaCedula()" class="form-control" name="cedula" id="cedula" placeholder="Ingrese la cedula">
                            </div> 
                            
                            <div class="col-sm-1" >
                                <button type="button" class="btn btn-sm btn-info btn-block" style="margin-top: 5px" onclick="consultaRc()">Buscar</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nombre_retira" id="nombre_retira" placeholder="Ingrese el Nombre">
                            </div> 
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionBodega/egreso_bodega_gral.js?v='.rand())}}"></script>
