                            ...
                            <div class="col-md-12 col-sm-12"  id="seccion_detalle">        
                                ...
                                <div id="div_infor_apr">
                                    ...
                                    <div class="row_" style="font-size: 13px">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="fecha_Actual" id="fecha_Actual" type="hidden">
                                ...
                                <div class="col-md-12" style="margin-top: 15px !important">
                                    <center>
                                        ...
                                        <button onclick="anular()" id="btn_anular"  type="button" class="btn btn-warning btn-xs ocultar_btn" ><span class="fa fa-trash"></span> Anular</button>
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionBodega/listado_pedido_bodega_new.js?v='.rand())}}"></script>
    <script>
