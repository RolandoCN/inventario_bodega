                                    ...
                                    <div class="row_" style="font-size: 13px">
                                        ...
                                        <div id="seccion_receta">
                                            <div class="col-md-6">
                                                ...
                                                <ul class="nav nav-pills nav-stacked" style="margin-left:0px" id="cie_">
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionFarmacia/listado_pedido_bodega.js?v='.rand())}}"></script>
    <script>
