                            ...
                            <div class="col-md-12 col-sm-12"  id="seccion_detalle">        
                                ...
                                <div id="div_infor_apr">
                                    ...
                                    <div class="row_" style="font-size: 13px">
                                        ...
                                        <div class="col-md-6">
                                            <ul class="nav nav-pills nav-stacked" style="margin-left:0px">
                                                <li style="border-color: white"><a><i class="fa fa-user text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Medico:</b> <span  class="funcionario_detalle"> </span></a></li>
                                        ...
                                        <div class="col-md-12">
                                            <ul class="nav nav-pills nav-stacked"style="margin-left:0px">
                                                <li style="border-color: white"><a><i class="fa fa-building text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Bodega</b>: <span  class="bodega_detalle">  </span></a></li>
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionFarmacia/listado_receta.js?v='.rand())}}"></script>
    <script>
