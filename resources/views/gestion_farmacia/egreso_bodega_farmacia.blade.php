...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Administración de Egreso en Farmacia
        </h1>
    ...
    <section class="content" id="content_form">
        ...
        <div class="box" id="listado_funcionario">
            ...
            <div class="box-body">
                <form class="form-horizontal" id="form_egreso_bodega" autocomplete="off" method="post"
                action="">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-3 control-label">Motivo</label>
                        <div class="col-sm-6">
                            <textarea name="motivo" id="motivo" class="form-control" placeholder="Ingrese el motivo"></textarea>
                        </div>                           
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select data-placeholder="Seleccione Una Opcion" style="width: 100%;" class="form-control select2" name="cmb_tipo" id="cmb_tipo" onchange="tipoEgreso()"  >
                                <option value="" selected></option>
                                <option value="Interno" >Interno</option>
                                <option value="Externo" >Externo </option>
                                <option value="Devolucion" >Devolucion Bodega </option>
                             
                            </select>
                        </div>                           
                    </div>
                   
                    <div id="retirado_seccion" style="display: none">
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label">Institucion</label>
                            <div class="col-sm-5">
                                <select data-placeholder="Seleccione Una Institucion" style="width: 100%;" class="form-control select2" name="cmb_proveedor" id="cmb_proveedor">
        ...
        <div class="modal fade_ detalle_class"  id="modal_proveedor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                ...
                                <form class="form-horizontal" id="form_new_proveedor" autocomplete="off" method="post"
                                action="">
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-3 control-label">RUC</label>
                                        <div class="col-sm-6">
                                            <input type="number" maxlength="13" onKeyPress="if(this.value.length==13) return false;" class="form-control" name="ruc" id="ruc"  placeholder="RUC">
                                            
                                        </div>                      
                                    </div>

                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-3 control-label">Contacto</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-3 control-label">Empresa</label>
                                        <div class="col-sm-6">
                                            <input type="text"  autocomplete="of" class="form-control" name="empresa" id="empresa" placeholder="Empresa"  >
                                            
                                        </div>                      
                                    </div>

                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-3 control-label">Telefono</label>
                                        <div class="col-sm-6">
                                            <input type="number" autocomplete="of" class="form-control" name="telefono" id="telefono" placeholder="Telefono" maxlength="13" onKeyPress="if(this.value.length==13) return false;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="email" autocomplete="of" class="form-control" name="email" id="email" placeholder="Correo" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="button" onclick="guardaProveedor()" class="btn btn-success btn-sm">Guardar</button>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="cerrarNuevoProveedor()">Volver</button>
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionFarmacia/egreso_bodega_farmacia.js?v='.rand())}}"></script>
