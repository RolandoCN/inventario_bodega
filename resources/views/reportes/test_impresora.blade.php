...
<body>
    <div class="ticket centrado">
        ...
        <table width="70%" style="padding-bottom:2px !important; margin-left:30px;margin-right:30px;margin-top:10px; border-top: 0px solid rgb(252, 24, 24) !important">
                ...
                <tr class="centrado" style="font-size: 7px !important">
                    <td width="100%" style="text-align: center"><b>COMPROBANTE DE EGRESO DE BODEGA</b> </td>
                </tr>
                <tr class="centrado" style="font-size: 7px !important">
                ...
                @if(isset($comprobante))
                    ...
                    @foreach($comprobante->detalle_item as $e=>$dato)
                        @if($dato->pedido->cantidad_entregada>0)
                            ...
                            <tr style="font-size: 7px !important;border-top: 1px solid black">
                                <td width="60%"> {{$dato->itemlab->descri}} </td>
    ...
    <div style="margin-top:50px; margin-left:30px;margin-right:30px; font-size:7px !important">
        <hr>
        <p class="encabezado1" style="font-size:7px !important"><b>RECIBI CONFORME</b></p>
    ...
    <div style="margin-top:60px; margin-left:30px;margin-right:30px;">
        <hr>
        <p class="encabezado1"  style="font-size:7px !important"><b>ENTREGUE CONFORME</b></p>
        <p class="encabezado1_" style="line-height: 10px">
