                ...
                <tbody>
                    ...
                    @if(isset($data))
                        ...
                        @foreach($data as $e=>$dato)
                            ...
                            @if($filtro=="Caducados")
                                @if(strtotime($fecha) > strtotime($dato->fcaduca))
                            ...
                            @elseif($filtro=="Porcaducar" && strtotime($dato->fcaduca) >= strtotime(date('Y-m-d')))
                                
                                @if(strtotime($dato->fcaduca) < strtotime($tres_meses) && $dato->existencia>0)
                            ...
                            @elseif($filtro=="Rotura" && strtotime($dato->fcaduca) >= strtotime(date('Y-m-d')))
