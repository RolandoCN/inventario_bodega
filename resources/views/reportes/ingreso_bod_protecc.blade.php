                    ...
                    @if(isset($comprobante))
                        ...
                        @foreach($comprobante->detalle as $e=>$dato)
                            <tr style="font-size: 10px !important;line-height:10px; "> 
                                ...
                                <td align="codigo" style="border-top: 0px;border-left: 0px; border-bottom: 0px;border-center:0px;border-right:0px;border-color: #D3D3D3">
                                    {{$dato->itemproteccion->codigo}} 
                                </td>
