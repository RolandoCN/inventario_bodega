...
@section('content')
    ...
    <section class="content" id="content_form">
        ...
        <div class="box" id="listado_area">
            ...
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table id="tabla_area" width="100%"class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Área</th>
                                <th>Horario Administrativo</th>
        ...
        <div id="form_ing" style="display:none">
            <form class="form-horizontal" id="form_area" autocomplete="off" method="post"
                action="">
                {{ csrf_field() }}
                <div class="box">
                    <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputPassword3" class="col-sm-3 control-label">Administrativo (8 horas)</label>
                            <div class="col-sm-8">
                                <select data-placeholder="Seleccione Un Opción" style="width: 100%;" class="form-control select2" name="es_admin" id="es_admin" >
...
@section('scripts')
    ...
    <script src="{{ asset('js/gestionArea/area.js?v='.rand())}}"></script>
